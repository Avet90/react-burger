...
import checkind from '../../images/done.svg'
    ...
    return (
        ...
        <div className={style.content}>
            <div className={`${style.order_number} mb-8`}><span
                className={`${style.order_number}text text_type_digits-large`}>{orderId}</span></div>
            <div><p className={`${style.title} text text_type_main-medium`}>идентификатор заказа</p></div>
            <div className={`${style.image_container} mt-15 mb-15`}><img src={checkind} alt='Галочка'></img></div>
